...
class TestRAGModeGeneration(unittest.TestCase):
    """CT-001: RAG mode normal generation tests"""
...
class TestBusinessInfoInjection(unittest.TestCase):
    """CT-002: Business info injection tests"""
...
class TestPlaceholderElimination(unittest.TestCase):
    """CT-003: Placeholder elimination tests"""
...
class TestLLMFallback(unittest.TestCase):
    """CT-004 + LF series: LLM fallback path tests"""
...
class TestQualityScoring(unittest.TestCase):
    """CT-005: Content quality scoring tests"""
...
class TestGateCONTENT01(unittest.TestCase):
    """G-CONTENT-01: Content specificity gate (P0 blocking)

    Core acceptance criteria defined by CDR, must all pass before release
    """
