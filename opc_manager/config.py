...
class ConfigManager:
    ...
    def __init__(self, config_path: str = "config.toml"):
        ...
        self.last_modified_time = os.path.getmtime(self.config_path) if os.path.exists(self.config_path) else 0
        ...
        try:
            with self._lock:
                ...
                if new_config:
                    ...
                    self.last_modified_time = os.path.getmtime(self.config_path) if os.path.exists(self.config_path) else 0
                    print(f"[ConfigManager] Configuration reloaded from {self.config_path}")
                    # 触发回调
