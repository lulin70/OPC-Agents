"""
Scenario Engine V2 - Supports 9 core scenarios + 6 business types

Based on architecture design document v2.1
Supports business type awareness, persona system integration, structured workflow orchestration
"""
...
class OutputSpec:
    ...
    name: str
    format: str  # JSON/Table/PDF/Excel/Calendar/Markdown etc.
...
class WorkflowStep:
    ...
    executor: str = ""  # Executor name, e.g. "hotspot_scanner", "llm_writer"
...
class ScenarioEngineV2:
    ...
    def __init__(self):
        ...
        self.type_detector = None  # Will be implemented in dev-2
        self.persona_manager = None  # Will be implemented in dev-4

    def _load_scenarios(self) -> Dict[str, ScenarioConfig]:
        """Load all 9 scenario configurations"""
        scenarios = {}

        # ========== Original scenarios (v2.0 compatible) ==========
    ...
    def _organize_meeting_scenario(self) -> ScenarioConfig:
        ...
        return ScenarioConfig(
            ...
            target_business_types=BusinessType.get_all_types(),  # Universal for all types
    ...
    # ==================== New scenario definitions (v2.1) ====================

    def _content_calendar_scenario(self) -> ScenarioConfig:
        """Content calendar planning scenario - For type 1 content creators"""
        return ScenarioConfig(
            id="content_calendar",
            name="内容日历规划",
    ...
    def _digital_product_launch_scenario(self) -> ScenarioConfig:
        """Digital product launch scenario - For type 2 digital product developers"""
        return ScenarioConfig(
    ...
    def _feedback_analysis_scenario(self) -> ScenarioConfig:
        """User feedback analysis scenario - For type 3 AI tool developers"""
        return ScenarioConfig(
    ...
    def _consulting_proposal_scenario(self) -> ScenarioConfig:
        """Consulting proposal scenario - For type 4 professional consultants"""
        return ScenarioConfig(
    ...
    def _ecommerce_ops_scenario(self) -> ScenarioConfig:
        """E-commerce operations scenario - For type 5 e-commerce operators"""
        return ScenarioConfig(
            id="ecommerce_ops",
            name="电商运营优化",
    ...
    def _project_deliverable_scenario(self) -> ScenarioConfig:
        """Project deliverable scenario - For type 6 creative workers"""
        return ScenarioConfig(
    ...
    def process(
        ...
        detected_type = (
            BusinessType.CONTENT_CREATOR
        )  # Default value, replaced by BusinessTypeDetector later
        ...
        if self.type_detector:
            try:
                ...
                detected_type = detection_result.business_type  # Extract BusinessType enum value
