    ...
    def _init_keyword_database_v2(self) -> Dict[BusinessType, Dict[str, Any]]:
        ...
        return {
            BusinessType.CONTENT_CREATOR: {
                ...
                "weight": 1.6,
                "primary_keywords": [
                    "内容", "创作", "写作", "文章", "博客", "公众号", "小红书", "抖音",
                    "视频", "直播", "UP主", "博主", "粉丝", "涨粉", "爆款", "选题",
                    "日历", "排期", "种草", "完播率", "互动率", "阅读量", "10万+",
                    "流量", "变现", "广告", "品牌合作", "MCN", "笔记", "图文",
                    "短视频", "中视频", "长视频", "投流", "达人", "KOL", "KOC", "矩阵",
                ],
                "secondary_keywords": [
                    "发布", "更新", "推送", "素材", "文案", "标题", "封面", "脚本",
                    "拍摄", "剪辑", "平台", "算法", "推荐", "热搜", "话题", "点赞",
                    "评论", "转发", "收藏", "分享", "粉丝画像", "用户画像", "账号运营",
                ],
                "context_phrases": [
                    "帮我写一篇", "下周发什么", "内容规划", "粉丝画像", "多平台",
                    "矩阵运营", "我的小红书", "我的抖音", "涨粉技巧",
                ],
                "synonyms": {
                    "内容创作": ["自媒体", "新媒体", "内容生产"],
                    "爆款": ["爆文", "热门", " viral"],
            ...
            BusinessType.DIGITAL_PRODUCT: {
                ...
                "weight": 1.4,
                "primary_keywords": [
                    "数字产品", "知识付费", "课程", "电子书", "模板", "小报童",
                    "Gumroad", "Teachable", "产品上架", "定价", "销售页",
                    "landing page", "漏斗", "付费用户", "订阅", "会员", "社群",
                    "知识星球", "专栏", "训练营", "SaaS", "工具", "插件",
                    "Notion模板", "Excel模板", "PPT模板", "付费阅读", "付费社群", "会员制",
                ],
                "secondary_keywords": [
                    "售卖", "收入", "营收", "转化率", "客单价", "复购", "续费",
                    "退款", "评价", "评分", "产品包装", "USP", "卖点", "价值主张",
                    "预售", "早鸟价", "限时优惠", "满减",
                ],
                "context_phrases": [
                    "我要卖", "如何定价", "写销售页", "产品发布", "上线",
                    "推广课程", "在Gumroad上", "在Teachable上", "知识变现",
                ],
                "synonyms": {
                    "数字产品": ["虚拟产品", "信息产品", "在线课程"],
                    "知识付费": ["知识变现", "付费内容", "付费社群"],
            ...
            BusinessType.AI_TOOL_BUILDER: {
                ...
                "weight": 1.5,
                "primary_keywords": [
                    "AI工具", "人工智能", "API", "GPT", "LLM", "ChatGPT", "Claude",
                    "模型", "训练", "微调", "应用", "插件", "扩展", "Agent", "智能助手",
                    "自动化", "代码", "开源", "GitHub", "部署", "用户反馈", "评论",
                    "Issues", "PR", "版本", "功能", "迭代", "路线图", "roadmap", "SDK",
                    "Latency", "Throughput", "Scalability", "Tech Debt", "Refactor",
                    "Deploy", "CI/CD",
                ],
                "secondary_keywords": [
                    "技术文档", "SDK", "集成", "接口", "Token", "调用", "延迟",
                    "性能", "优化", "Bug", "Feature Request", "Changelog", "Release",
                    "Docker", "Kubernetes", "Microservice", "RESTful", "GraphQL",
                    "Webhook", "Rate Limiting", "Caching",
                ],
                "context_phrases": [
                    "我的工具", "用户说", "App Store评论", "GitHub Issues",
                    "新功能", "版本更新", "我的API", "我的应用", "我的产品",
                ],
                "synonyms": {
                ...
                "domain_phrases": [
                    "RICE评分", "MoSCoW法则", "Kano模型", "OKR", "Agile", "Scrum",
                    "Code Review", "TDD", "单元测试", "集成测试", "端到端测试",
                ],
            },
            BusinessType.CONSULTANT: {
                ...
                "weight": 1.3,
                "primary_keywords": [
                    "咨询", "顾问", "提案", "建议书", "方案", "客户", "项目", "服务",
                    "专业", "专家", "战略", "规划", "分析", "研究", "报告", "演示",
                    "汇报", "PPT", "交付物", "合同", "报价", "费用", "时薪", "按项目",
                    "retainer", "方法论", "框架", "SWOT", "PESTEL", "商业模式画布", "价值链分析",
                ],
                "secondary_keywords": [
                    "行业", "市场", "竞争", "痛点", "需求", "解决方案", "最佳实践",
                    "案例", "经验", "洞察", "利益相关者", "Stakeholder", "里程碑",
                    "KPI", "ROI", "投资回报", "验收标准",
                ],
                "context_phrases": [
                    "我的客户", "给客户写", "咨询项目", "服务报价", "专业建议",
                    "客户要做", "帮客户", "为甲方",
                ],
                "synonyms": {
                    "咨询": ["顾问服务", "专业服务", "咨询服务"],
                ...
                "domain_phrases": [
                    "SMART原则", "RACI矩阵", "PDCA循环", "五力模型", "BCG矩阵",
                    "安索夫矩阵", "价值主张设计", "精益画布",
                ],
            },
            BusinessType.ECOMMERCE: {
                ...
                "weight": 1.4,
                "primary_keywords": [
                    "电商", "淘宝", "天猫", "京东", "拼多多", "店铺", "商品", "SKU",
                    "库存", "订单", "发货", "物流", "快递", "GMV", "销售额", "转化率",
                    "客单价", "访客", "UV", "PV", "直通车", "钻展", "促销", "活动",
                    "双十一", "618", "直播带货", "供应链", "选品", "DSR", "动销率",
                    "复购率", "退货率", "问大家", "好评率", "发货时效",
                ],
                "secondary_keywords": [
                    "详情页", "主图", "标题优化", "SEO", "评价", "退款", "售后",
                    "客服", "旺信", "聚划算", "秒杀", "满减", "优惠券", "红包",
                    "达人带货", "直播间", "品销宝", "超级推荐",
                ],
                "context_phrases": [
                    "我的店铺", "商品上架", "活动报名", "库存预警", "订单处理",
                    "我的淘宝店", "我的京东店", "在拼多多上",
                ],
                "synonyms": {
                    "电商": ["网店", "线上店铺", "电子商务"],
            ...
            BusinessType.CREATIVE_WORK: {
                ...
                "weight": 1.3,
                "primary_keywords": [
                    "设计", "创意", "作品", "交付", "客户", "UI", "UX", "平面",
                    "品牌", "logo", "插画", "摄影", "视频制作", "剪辑", "作品集",
                    "portfolio", "提案", "样机", "Figma", "Sketch", "Photoshop",
                    "AI绘画", "Midjourney", "Stable Diffusion", "DALL-E", "排版",
                    "配色", "字体", "图标", "视觉", "品牌VI", "包装设计", "海报", "H5页面",
                ],
                "secondary_keywords": [
                    "视觉", "配色", "排版", "字体", "图标", "原型", "交互", "动效",
                    "渲染", "素材", "版权", "商用", "授权", "样机", "Mockup",
                    "Design System", "Style Guide",
                ],
                "context_phrases": [
                    "设计稿", "效果图", "客户反馈", "作品集整理", "创意方案",
                    "我的设计", "帮做个logo", "设计个海报",
                ],
                "synonyms": {
                    "设计": ["Design", "视觉设计", "平面设计"],
