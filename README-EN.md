...
> **Version**: v0.3.28 | **Status**: Beta | **License**: MIT
...
- **🔧 v0.3.28 Fixed CI all-red issue**: Unified ruff version to 0.15.21 (CI 0.6.9→0.15.21) + corrected README test count (4278→4193). v0.4.0 release pending D04 re-evaluation.
