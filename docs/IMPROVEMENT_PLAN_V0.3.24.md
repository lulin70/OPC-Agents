...
- ✅ v0.4.0 发布门控 14/14 全部达标（v0.3.27 完成）:
  - ✅ G1 pip-audit 0 漏洞 + Bandit 0 高危（6 包升级修复 21 漏洞）
  - ✅ G2 E2E 真实用户测试 0 失败（阈值 15s→30s 匹配文档质量门）
  - ✅ G3 基础版本地运行验证 HTTP 200（localhost:8501）
  - ✅ G4 weekly-e2e-real.yml 手动触发 success（run 29261499813）
