...
| 收集总数 | `pytest --co -q --no-header` | `4970 tests collected`（原 4894 → +29 单测 +43 CRM E2E +4 Docker E2E） |
| 三语 README 一致性 | CI 原样 heredoc 脚本 | `✓ 三语 README 一致性校验通过（版本 0.5.9, 模块 99, 测试 4970）` |
...
- 文档：三语 README 测试数 4894 → 4970、JP 测试文件数 137 → 138；本文件与 `SKILL_FREEZE_LIST_V1.0.0.md` §5/§6 勾选。
