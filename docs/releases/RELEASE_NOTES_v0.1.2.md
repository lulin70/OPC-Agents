...
| 指标 | 修复前 | 修复后 | 改进 |
|------|--------|--------|------|
| 首次请求延迟 | 800-1200ms | 300-700ms | ⬇ -500ms (42%) |
| 后续请求延迟 | 500-800ms | 300-500ms | ⬇ -300ms (38%) |
| Token使用 | ~700 tokens | ~300 tokens | ⬇ -400 tokens (57%) |
| 内存占用 | ~180MB | ~150MB | ⬇ -30MB (17%) |
