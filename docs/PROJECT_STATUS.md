...
> **最后更新**: 2026-07-10（P2-P3 技术债清理批次完成，v0.3.6 发布） | **版本**: v0.3.6 (Beta) | **许可**: MIT
>
...
- CI coverage 阈值 59% (含 frontend 总覆盖率 ~60%, opc_manager 单独 ~70%) → 目标 65% → 80%
