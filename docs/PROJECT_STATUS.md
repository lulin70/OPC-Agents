...
> **最后更新**: 2026-07-12（D02 评估 P0 修复：版本号同步 + 工作区清理 + CI 校验扩展，v0.3.21 发布） | **版本**: v0.3.21 (Beta) | **许可**: MIT
>
