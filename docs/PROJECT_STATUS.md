...
> **最后更新**: 2026-07-13（v0.4.0 发布门控 11/11 全部达标：安全扫描+E2E+本地运行+weekly-e2e 工作流，v0.3.27 发布） | **版本**: v0.3.27 (Beta) | **许可**: MIT
>
...
| 测试通过 | 4278 passed, 111 skipped, 0 timeout | `pytest --ignore=tests/e2e --timeout=30`（v0.3.24 修复 6 个 timeout，v0.3.25 新增 99 个覆盖测试，v0.3.26 修复 56 处 Mock 反模式） |
